...
pub struct PolarMeshStyle<'a, 'b, R: Ranged, T: Ranged, DB: DrawingBackend> {
    ...
    pub(super) format_x: Option<&'b dyn Fn(&R::ValueType) -> String>,
    pub(super) format_y: Option<&'b dyn Fn(&T::ValueType) -> String>,
    pub(super) target: Option<&'b mut ChartContext<'a, DB, Polar2d<R, T>>>,
    pub(super) _phantom_data: PhantomData<(R, T)>,
    pub(super) x_tick_size: [i32; 2],
    pub(super) y_tick_size: [i32; 2],
}

impl<'a, 'b, R, T, RT, TT, DB> PolarMeshStyle<'a, 'b, R, T, DB>
where
    R: Ranged<ValueType = RT> + ValueFormatter<RT>,
    T: Ranged<ValueType = TT> + ValueFormatter<TT>,
    DB: DrawingBackend,
{
    pub fn new(chart: &'b mut ChartContext<'a, DB, Polar2d<R, T>>) -> Self {
...
impl<'a, 'b, R, T, DB> PolarMeshStyle<'a, 'b, R, T, DB>
where
    R: Ranged,
    T: Ranged,
    DB: DrawingBackend,
{
    ...
    pub fn axis_style<S: Into<ShapeStyle>>(&mut self, style: S) -> &mut Self {
    ...
    pub fn bold_line_style<S: Into<ShapeStyle>>(&mut self, style: S) -> &mut Self {
    ...
    pub fn light_line_style<S: Into<ShapeStyle>>(&mut self, style: S) -> &mut Self {
    ...
    pub fn label_style<S: IntoTextStyle<'b>>(&mut self, style: S) -> &mut Self {
    ...
    /// - `style`: The text style that would be applied to the labels
    pub fn x_label_style<S: IntoTextStyle<'b>>(&mut self, style: S) -> &mut Self {
    ...
    /// - `style`: The text style that would be applied to the labels
    pub fn y_label_style<S: IntoTextStyle<'b>>(&mut self, style: S) -> &mut Self {
    ...
    pub fn x_label_formatter(&mut self, fmt: &'b dyn Fn(&R::ValueType) -> String) -> &mut Self {
    ...
    /// - `fmt`: The formatter function
    pub fn y_label_formatter(&mut self, fmt: &'b dyn Fn(&T::ValueType) -> String) -> &mut Self {
    ...
    pub fn axis_desc_style<S: IntoTextStyle<'b>>(&mut self, style: S) -> &mut Self {
    ...
    pub fn x_desc<D: Into<String>>(&mut self, desc: D) -> &mut Self {
    ...
    pub fn y_desc<D: Into<String>>(&mut self, desc: D) -> &mut Self {
    ...
    where
        R: ValueFormatter<<R as Ranged>::ValueType>,
        T: ValueFormatter<<T as Ranged>::ValueType>,
    {
