...
<div class="galleryItem">
    <a href="https://plotters-rs.github.io/plotters-doc-data/bitmap-blit.png">
        <img src="https://plotters-rs.github.io/plotters-doc-data/blitmap-blit.png" class="galleryItem"></img>
    </a>
    <div class="galleryText">
        Drawing bitmap on chart
        <a href="https://github.com/38/plotters/blob/master/examples/blitmap-blit.rs">[code]</a>
    </div>
</div>
